            ...
            <header className="sticky top-0 z-40 border-b border-border/60 bg-background/70 backdrop-blur-xl">
              <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-6 py-5">
                ...
                <div className="flex items-center gap-3">
                  <nav className="hidden items-center gap-3 rounded-full border border-border/70 bg-card/70 px-3 py-1 text-xs font-medium text-muted-foreground backdrop-blur md:flex">
                    <Link href="/" className="transition hover:text-foreground">Dashboard</Link>
                    <span aria-hidden className="h-4 w-px bg-border" />
                    <Link href="/practice" className="transition hover:text-foreground">Practice</Link>
                    <span aria-hidden className="h-4 w-px bg-border" />
